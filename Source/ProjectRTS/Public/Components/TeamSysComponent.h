...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnTeamChanged, int32, NewFaction);
...
public:
	...
	UFUNCTION(BlueprintPure, Category = "Team")
	bool IsAllyByFaction(int32 Faction) const;

	UFUNCTION(BlueprintPure, Category = "Team")
	bool IsEnemyByFaction(int32 Faction) const;

public:
	// --- 팀 시스템 변수 및 함수 ---
	UPROPERTY(ReplicatedUsing = OnRep_Faction, BlueprintReadWrite, Category = "Team")
	int32 m_Faction;
